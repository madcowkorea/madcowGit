...
public class Gallery_Detil_MainActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        testList = (ArrayList<String>) intent.getStringArrayListExtra("CheckOn");
        Serializable s = intent.getSerializableExtra("CheckOn");
        layoutIndicators = findViewById(R.id.layoutIndicators);
        viewPager = findViewById(R.id.Detil_View_Pager);
        viewPager.setOffscreenPageLimit(testList.size());
        viewPager.setAdapter(new ViewPagerAdapter(testList, this));
    }
}