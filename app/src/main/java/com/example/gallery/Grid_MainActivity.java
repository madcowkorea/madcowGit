...
public class Grid_MainActivity extends BaseActivity implements CallbackListener{
    ...
    AutoCastMap dataMap; //Bean
    ArrayList<AutoCastMap> dataList_tmp; // 전체 List
    DataListAdapter dataListAdapter; // List Adapter

    ArrayList<String> imgDelList = new ArrayList<>(); //이미지 삭제 List
    ArrayList<String> detilList = new ArrayList<>(); // 이미지 상세보기 List
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //이미지상세보기 리스너
        detilImgClickEvent submitbtn = new detilImgClickEvent();
        detil.setOnClickListener(submitbtn);


        dataList_tmp = new ArrayList<>();
        dataListAdapter = new DataListAdapter(Grid_MainActivity.this, dataList_tmp);
        Rv.setAdapter(dataListAdapter);
        dataListAdapter.setCallbackListener(Grid_MainActivity.this);
